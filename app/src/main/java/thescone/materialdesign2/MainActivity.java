package thescone.materialdesign2;
...
public class MainActivity extends AppCompatActivity {
    ...
    class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        /*
        Setting only icon to tab is same as setting text and icon except
        the method getPageTitle() in ViewPagerAdapter class returns null
        instead of tab label.
         */
    }
}
